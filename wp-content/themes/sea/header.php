		...
		<div class="header section small-padding bg-dark bg-image" style="background-image: url(<?php if (get_header_image() != '') : ?><?php header_image(); ?><?php else : ?><?php echo get_template_directory_uri() . '/images/header.jpg'; ?><?php endif; ?>);">
			...
			<div class="header-inner section-inner">
				...
				<?php if ( get_theme_mod( 'sea_logo' ) ) : ?>
					...
					<div class="blog-logo">
				        ...
				        <a class="logo" href='<?php echo esc_url( home_url( '/' ) ); ?>' title='<?php echo esc_attr( get_bloginfo( 'title' ) ); ?> &mdash; <?php echo esc_attr( get_bloginfo( 'description' ) ); ?>' rel='home'>
							<img class="logo-icon" src="<?php bloginfo('template_directory'); ?>/images/fg_logo.png" alt="logo"/>
				        </a>
				...
				<?php elseif ( get_bloginfo( 'description' ) || get_bloginfo( 'title' ) ) : ?>
						...
						<h1 class="blog-title">
							<a href="<?php echo esc_url( home_url() ); ?>" title="<?php echo esc_attr( get_bloginfo( 'title' ) ); ?> &mdash; <?php echo esc_attr( get_bloginfo( 'description' ) ); ?>" rel="home"><img class="logo-icon" src="<?php bloginfo('template_directory'); ?>/images/fg_logo.png" alt="logo"/> <?php echo esc_attr( get_bloginfo( 'title' ) ); ?></a>
						</h1>
