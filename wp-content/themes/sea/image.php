            ...
            <div class="content fleft">
                ...
                <div id="post-<?php the_ID(); ?>" <?php post_class('post'); ?>>
                    ...
                    <div class="featured-media">
                        ...
                        <a href="<?php echo esc_url($imageArray[0]); ?>" title="<?php the_title_attribute(); ?>"
                           rel="attachment">
                    ...
                    <div class="post-meta-container">
                        ...
                        <div class="post-author">
                            ...
                            <div class="post-author-content">
                                ...
                                <h4><?php _e('Більш детально', 'sea'); ?></h4>
                        ...
                        <div class="post-meta">
                            ...
                            <p class="image-resolution"><?php echo $imageArray[1] // 1 is the width ?> <span
                                    style="text-transform:lowercase;">x</span> <?php echo $imageArray[2] . ' px'; // 2 is the height ?>
                            </p>
