						...
						foreach($users as $user) {
							...
							<div class="one-half author-info">
								...
								<div class="author-links">
									...
									<?php if ( !empty($user->user_email) ) : ?><a class="author-link-mail" href="mailto:<?php echo $user->user_email; ?>"><?php _e('E-mail','sea'); ?></a><?php endif; ?>
									
									<?php if ( !empty($user->user_url) ) : ?><a class="author-link-website" href="<?php echo $user->user_url; ?>"><?php _e('Website', 'sea') ?></a><?php endif; ?>
									<?php if ( !empty($user->twitter) ) : ?><a class="author-link-twitter" href="http://www.twitter.com/<?php echo $user->twitter; ?>"><?php _e('Twitter', 'sea'); ?></a><?php endif; ?>
